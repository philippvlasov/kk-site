    ...
    <nav class="menu">
        <a href="#">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 1366 225" xml:space="preserve">
            <style type="text/css">
                .st0 {
                    fill: #FBB03B;
                }
        ...
        <ul>
            <li>
                <a href="/" data-section="1">Главная</a>
            </li>
            <li>
                <a href="/about" data-section="2">О проекте</a>
            </li>
            <li>
                <a href="/services" data-section="3">Услуги</a>
            </li>
            <li>
                <a href="/reviews" data-section="4">Отзывы</a>
            </li>
            <li>
                <a href="/portfolio" data-section="5">Портфолио</a>
            </li>
            <li>
                <a href="contacts" data-section="6">Контакты</a>
            </li>
        </ul>
    </nav>
@endsection
